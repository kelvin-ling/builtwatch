...
2. This is for one app profile, not for discovering every app in the agent’s project. Copy the private setup instructions into that app’s agent conversation.
